...
namespace GWSuncoastAPI.Entity.UnitofWork
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        GWSuncoastAPIContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public GWSuncoastAPIContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(GWSuncoastAPIContext context)
        {
            Context = context;
            _disposed = false;
        }
