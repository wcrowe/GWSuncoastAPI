...
namespace GWSuncoastAPI.Entity.Context
{
    public partial class GWSuncoastAPIContext : DbContext
    {

        public GWSuncoastAPIContext(DbContextOptions<GWSuncoastAPIContext> options)
            : base(options)
        {
        }
